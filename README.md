...
Este repositório centraliza meu aprendizado sobre o ecossistema **Ubuntu/Linux**. Através de um
**script Bash interativo**, organizei comandos essenciais, dicas de administração de sistemas e automações em um único lugar.

## 🚀 Objetivo
Facilitar a configuração de novas máquinas e servir como uma base de consulta rápida para comandos que vão desde o básico até
o diagnóstico avançado de redes e segurança.
